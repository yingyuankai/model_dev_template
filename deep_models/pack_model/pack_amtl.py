        ...
        with self.sess as sess:
            ...
            output_graph_def = \
                graph_util.convert_variables_to_constants(sess, graph_def, [
                    ...
                    # "output_1/accu/BiasAdd",
                    "output_accu/accu/BiasAdd",
                    # "output_2/impris/BiasAdd",
                    "output_impris/impris/BiasAdd",
                    "output_death/death/BiasAdd",
                ])

            with tf.gfile.GFile(os.path.join(self.config.model_output_path, "model_{}{}{}_{}_{}_{}_{}{}.pb".format(int(self.config.rebalance),
