...
class Predictor(BasePredict):
    ...
    def _load_models(self):
        try:
            model_path = os.path.join(self._config.model_output_path, "model_{}{}{}_{}_{}_{}_{}{}.pb".format(int(self._config.rebalance),
    ...
    def _extract_ops(self):
        ...
        # self.accu = self._graph.get_tensor_by_name("{}/output_1/accu/BiasAdd:0".format(self._config.op_prefix))
        self.accu = self._graph.get_tensor_by_name("{}/output_accu/accu/BiasAdd:0".format(self._config.op_prefix))
        # self.impris = self._graph.get_tensor_by_name("{}/output_2/impris/BiasAdd:0".format(self._config.op_prefix))
