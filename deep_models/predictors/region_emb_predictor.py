...
class Predictor(BasePredict):
    ...
    def _load_models(self):
        try:
            with tf.gfile.FastGFile(os.path.join(self._config.model_output_path, "{}.pb".format(self._config.exp_name)), "rb") as f:
    ...
    def _extract_ops(self):
        ...
        self.law = self._graph.get_tensor_by_name("{}/output/xw_plus_b:0".format(self._config.op_prefix))
        self.accu = self._graph.get_tensor_by_name("{}/output/xw_plus_b_1:0".format(self._config.op_prefix))
        self.impris = self._graph.get_tensor_by_name("{}/output/xw_plus_b_2:0".format(self._config.op_prefix))
        self.dropout = self._graph.get_tensor_by_name("{}/dropout:0".format(self._config.op_prefix))
