...
class Model(BaseModel):
    ...
    def build_model(self):
        ...
        # impris loss
        self.loss_impris = loss_regress_new(self.logits_impris, self.imprisonments, self.config.impris_mean, self.config.impris_std,
                                        loss_weight=None)
        ...
        with tf.variable_scope("f1"):
            ...
            self.accuracy_impris = cal_regess_accuracy(self.logits_impris, self.imprisonments,
                                                       self.config.impris_mean, self.config.impris_std, 'impris')
        ...
        tf.summary.scalar("error_impris", self.accuracy_impris)
