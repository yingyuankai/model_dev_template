    ...
    def _load_model(self):
        try:
            ...
            checkpoint_path = os.path.join(
                ...
                # "./log_all_textcnn_111_2018070103/ckpt",
        ...
        with self.sess as sess:
            ...
            output_graph_def = \
                graph_util.convert_variables_to_constants(sess, graph_def, [
                    ...
                    # "output/impris/BiasAdd",
                    "output_impris/impris/BiasAdd",
                    "output_death/death/BiasAdd",
                ])

            model_path = os.path.join(self.config.model_output_path,
                         "model_{}{}{}_{}_{}_{}_{}_{}{}{}.pb".format(int(self.config.rebalance),
